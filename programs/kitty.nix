{ pkgs, misc, lib, ... }: {
  ...
  home.file.kitty-nix = {
    ...
    text = lib.concatLines [
      ...
      ''TryExec=${pkgs.nixgl.nixGLIntel} ${pkgs.kitty}/bin/kitty''
      ''Exec=${pkgs.nixgl.nixGLIntel} ${pkgs.kitty}/bin/kitty''
  ...
  home.file.kitty-nix-open = {
    ...
    text = lib.concatLines [
      ...
      ''Comment=Fast, feature-rich, GPU based terminal''
      ''TryExec=${pkgs.nixgl.nixGLIntel} ${pkgs.kitty}/bin/kitty''
      ''Exec=${pkgs.nixgl.nixGLIntel} ${pkgs.kitty}/bin/kitty +open %U''
      ''Icon=${pkgs.kitty}/share/icons/hicolor/256x256/apps/kitty.png''
      ''Categories=System;TerminalEmulator;''
      ''NoDisplay=true''
