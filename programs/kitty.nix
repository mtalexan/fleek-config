  ...
  programs.kitty = {
    ...
    extraConfig = lib.concatLines [
      ...
      ''
        ...
        map kitty_mod+enter>h launch --type=window --cwd=current --copy-cmdline --location=vsplit
        map kitty_mod+enter>v launch --type=window --cwd=current --copy-cmdline --location=hsplit
