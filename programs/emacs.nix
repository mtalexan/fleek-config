{ pkgs, misc, lib, ... }: {
  ...
  # by creating this directory, basic prompted config options are put into this folder rather than
  # being changed inline within the cloned spacemacs repo in ~/.emacs.d
  home.file.".spacemacs.d" = {
    enable = true;
    force = true;
    # symlink this folder to the local one in this git repo
    recursive = false;
    # the folder next to this file.
    source = ./spacemacs.d;
  };
