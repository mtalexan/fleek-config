  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-jump-helm-line ace-link aggressive-indent alert all-the-icons
         ...
         holy-mode htmlize hungry-delete hybrid-mode indent-guide info+ inspector
         link-hint llama log4e lorem-ipsum lsp-mode lsp-origami lsp-treemacs
         lsp-ui macrostep magit magit-section markdown-mode markdown-toc memoize
         multi-line mwim nameless nerd-icons open-junk-file org
         ...
         org-superstar orgit orgit-forge origami overseer package-lint paradox
         password-generator pcre2el persistent-scratch popwin pos-tip quickrun
         ...
         treepy undo-fu undo-fu-session unfill uuidgen vi-tilde-fringe
