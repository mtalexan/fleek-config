{ pkgs, misc, lib, ... }: {
  ...
  programs.fzf = {
    ...
    defaultOptions = [
      ...
      "--bind 'ctrl-/:toggle-preview,alt-bs:backward-kill-word,alt-j:backward-char,alt-l:forward-char,alt-i:up,alt-k:down,alt-J:backward-word,alt-L:forward-word,alt-I:page-up,alt-K:page-down,ctrl-g:cancel,alt-u:beginning-of-line,alt-o:end-of-line,ctrl-n:next-history,ctrl-p:previous-history,ctrl-]:jump,alt-space:toggle-in,ctrl-space:toggle-in,ctrl-alt-k:preview-down,ctrl-alt-i:preview-up,ctrl-alt-I:preview-page-up,ctrl-alt-K:preview-page-down,alt-down:preview-down,alt-up:preview-up,alt-pgup:preview-page-up,alt-pgdn:preview-page-down'"
      "--border=sharp"
      "--info=inline"
      "--height=30%"
      "--min-height=10"
